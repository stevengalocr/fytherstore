...
export default function TermsPage() {
  return <PolicyPage
    ...
    intro="Estos términos describen el funcionamiento básico de Fyther Store y distinguen la simulación del comercio real."
    sections={[
      ...
      { title: 'Modo demostración', content: <p>Cuando la tienda muestra la etiqueta “Modo demo”, los productos, precios y pedidos son ficticios. No existe cobro, reserva de inventario ni compromiso de venta.</p> },
